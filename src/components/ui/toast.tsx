  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        'data-[type=success]:border-status-success/50 data-[type=error]:border-destructive/50 data-[type=warning]:border-history-marker/50',
...
function ToastIcon({ type }: { type: string | undefined }) {
  ...
  if (type === 'success') {
    icon = <CircleCheckIcon className="text-status-success" aria-hidden="true" />;
  }
  ...
  if (type === 'warning') {
    icon = <TriangleAlertIcon className="text-history-marker" aria-hidden="true" />;
  }
