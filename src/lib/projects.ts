...
export const BENEFICIARY_CATEGORIES: {
  ...
  { key: "nna_indirect", label: "NNA indirectos", definition: "Niñas, niños y adolescentes alcanzados a través de otra persona o institución que sí recibe acciones del equipo técnico." },
  ...
  { key: "other_adults", label: "Referentes y vecinos", definition: "Personas que reciben de forma directa acciones de sensibilización, prevención y promoción." },
